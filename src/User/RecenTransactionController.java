...
public class RecenTransactionController implements Initializable {
	    ...
	    public void setName(String name,String anumber) {
	    	username.setText(name);
	    	accountnumber.setText(anumber);
	    ...
	    public void Update() {
			...
			listlog = sqlconnect.getDatalog(username.getText(), accountnumber.getText());
	    ...
	    void out1(ActionEvent event) {
	    	try {
	    		...
	    		panelController.setName(username.getText());
